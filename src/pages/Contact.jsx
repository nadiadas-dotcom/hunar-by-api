          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="space-y-6">
                {[
                  { icon: MapPin, title: "Visit Us", content: "Karachi, Pakistan", sub: "Shop by appointment" },
                  { icon: Phone, title: "Call Us", content: "+92 333 3955487", sub: "Mon-Sat, 10AM - 7PM" },
